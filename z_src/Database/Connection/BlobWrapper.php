...
class BlobWrapper {
	 ...
	 * @return BlobWrapper
	 */
	public function __construct($contentText = null, $contentFileName = null) {
	...
	public function nextChunk() {
		...
		if (strlen($this->contentText) > 0) {
			...
			$nextChunk = substr ( $this->contentText, $this->stringPointer, 8192 );
			$this->stringPointer += 8192;
			return $nextChunk;
			...
			if (! feof ( $this->filePointer )) {
				return fread ( $this->filePointer, 8192 );
			} 
