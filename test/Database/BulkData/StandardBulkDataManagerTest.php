 ...
 */
class StandardBulkDataManagerTest extends \PHPUnit\Framework\TestCase {
    ...
    public function testBulkInsertCorrectlyCreatesAPreparedStatementOnceAndCallsItRepeatedly() {
        ...
        $manager = new StandardBulkDataManager($this->mockDatabaseConnection);
    ...
    public function testBulkReplaceCorrectlyReplaces() {
    ...
    public function testCanExecuteAllActionsWithRealDatabaseConnections() {
        ...
        $manager = new StandardBulkDataManager($databaseConnection);
