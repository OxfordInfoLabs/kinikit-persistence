...
//
//		DefaultDB::getConnection ()->query ( "DROP TABLE IF EXISTS test_child" ) or die ( "Couldn't drop table" );
//		DefaultDB::getConnection ()->query ( "CREATE TABLE test_child(id INTEGER AUTO_INCREMENT, note VARCHAR(20), parent_id INTEGER, PRIMARY KEY (id))" ) or die ( "Couldn't create table" );
//		DefaultDB::getConnection ()->query ( "DROP TABLE IF EXISTS test_child_multi_key" ) or die ( "Couldn't drop table" );
//		DefaultDB::getConnection ()->query ( "CREATE TABLE test_child_multi_key (id INTEGER AUTO_INCREMENT, description VARCHAR(20), parent_field1 INTEGER, parent_field2 VARCHAR(10), parent_field3 INTEGER, PRIMARY KEY (id))" ) or die ( "Couldn't create table" );
//
//		$mysqlConnection = DefaultDB::instance ();
//
