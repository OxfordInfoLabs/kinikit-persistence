...
CREATE TABLE example_many_to_many_link (parent_id integer, child_id integer);
...
INSERT INTO example_child_with_parent_key (description, parent_id) VALUES ('Laughing', 2);
INSERT INTO example_child_with_parent_key (description, parent_id) VALUES ('Smiling', 2);
INSERT INTO example_child_with_parent_key (description, parent_id) VALUES ('Walking', 3);
INSERT INTO example_child_with_parent_key (description, parent_id) VALUES ('Dancing', 3);

-- Create some many to many link relationships
INSERT INTO example_many_to_many_link (parent_id, child_id)
